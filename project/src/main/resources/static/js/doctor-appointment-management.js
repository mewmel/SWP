...
async function loadBookings() {
    ...
    try {
        ...
        currentBookings = await response.json(); // SỬA: appointments → bookings
...
function displayBookings(bookings) {
    const container = document.getElementById('appointmentsList'); // HTML element name giữ nguyên
    const noBookings = document.getElementById('noAppointments'); // HTML element name giữ nguyên
    const template = document.getElementById('bookingTemplate');
...
async function confirmBooking() {
    ...
    try {
        ...
        console.error('Error confirming booking:', error);
        showError('Không thể xác nhận booking. Vui lòng thử lại.');
    }
}
