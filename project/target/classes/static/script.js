...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (userFullName) {
        // Nếu đã đăng nhập, ẩn nút "Đăng nhập" và "Đăng ký", hiển thị menu người dùng
        authButtons.style.display = 'none';
        userMenu.style.display = 'flex';
        document.querySelector('.user-name').textContent = userFullName;
    } else {
        // Nếu chưa đăng nhập, hiển thị nút "Đăng nhập" và "Đăng ký", ẩn menu người dùng
